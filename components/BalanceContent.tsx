  ...
  const handleLinkAccount = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your bank account has been connected to Finance Tracker.",
      })
      ...
      toast({
        ...
        description: `${mockTransactions.length} transactions have been imported to your account.`,
      })
    } catch (error) {
      toast({
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-black/30 backdrop-blur-sm p-6 rounded-lg shadow-xl">
              <div className="flex items-center mb-6">
                <BanknoteIcon className="h-8 w-8 text-green-400 mr-3" />
            ...
            <div className="bg-black/30 backdrop-blur-sm p-6 rounded-lg shadow-xl">
              ...
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start">
                  <ArrowRight className="h-5 w-5 text-green-400 mr-2 mt-0.5" />
